...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Representation of the model to use in the output file name (if None, uses the model name)",
    )
    parser.add_argument(
        "--local_model_path",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to the custom output directory used in `custom_evaluator.py`",
    )
    parser.add_argument(
        "--custom_output_file",
        type=str,
